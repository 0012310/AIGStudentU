...
public class Constant {
    ...
    private static final String BASE_URL = "http://aigpl.com/android/Api_Functions.php?req=";
    ...
    public static final String VIEW_PREPA_EXAM_URL =BASE_URL+ "view_preparatory_exam";
}
